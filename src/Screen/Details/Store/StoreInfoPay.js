...
const StoreInfoPay = ({navigation,route}) => {
    ...
    const fetchAddress = async () => {
      if (region) {
        try {
          ...
          if (results[0] && results[0].display_name && addressL==true ) {
  ...
  const HandleConfimation = ()=>{
    navigation.navigate('StoreCommand',{
  ...
  const LocalizationRecuperation =()=>{
    setAddressR(true);
    navigation.navigate('Localization_StoreScreen',{
      // dataConfirmation : data,
      // numberArticale:numberArticale,
      // totalPrice:totalPrice
    })
...
<TouchableOpacity
    ...
    <View style={[styles.formContainner,{paddingHorizontal:10}]}>
              
              <View style={[styles.itemRow,{justifyContent:'space-between'}]}>       
                    <Text  style={styles.itemText2}>Frais de Livraison</Text>
                    <Text  style={[styles.itemText2]}>7 TND</Text>
              </View>
              <View style={styles.horizontalLine} />

              <View style={[styles.itemRow,{justifyContent:'space-between'}]}>       
                    <Text  style={styles.itemText2}>Total à payer</Text>
                    <Text  style={[styles.itemText2,{color:colors.primary}]}>43 TND</Text>
              </View>
    ...
    <View style={styles.actionButtonsContainer}>
        <TouchableOpacity style={styles.confirmButton} onPress={HandleConfimation} >
           <Text style={styles.actionButtonText}>Confirmer mes informations</Text>
        </TouchableOpacity>
      </View>
</View>
