...
const InfoPaymentScreen = ({navigation}) => {
  ...
  return (
    ...
    <ScrollView>
        ...
        <View style={styles.formContainner}>
          ...
          <Text style={styles.title}>Mode de Paiements</Text>
        ...
        <View style={styles.formContainner}>
          ...
          <View >
            ...
            <View style={styles.textContainer}>
                ...
                <Text style={styles.label}>7 DT</Text>
            </View>
            ...
            <View style={styles.textContainer}>
                ...
                <Text style={styles.label}>30 DT</Text>
            </View>
        ...
        <View style={styles.formContainner}>
          ...
          <View >
            ...
            <View style={styles.textContainer}>
                <Text style={styles.codePromo}>Code promo</Text>
