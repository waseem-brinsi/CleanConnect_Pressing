...
const WelcomeScreen = ({ navigation }) => {
  return (
    <SafeAreaView style={styles.safeArea}>
      <Image source={require('../../../assets/images/welcome/domicile.jpg')} style={styles.TshirtImage} />
      <View style={styles.container}>

        <Text style={styles.TitleText}>Nettoyage à domicile</Text>
        ...
        <TouchableOpacity style={styles.annulerButton} onPress={() => navigation.navigate('Home')}>
          ...
          <TouchableOpacity style={styles.button} onPress={() => navigation.navigate('Commencer')}>
